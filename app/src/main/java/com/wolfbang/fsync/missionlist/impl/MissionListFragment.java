...
import com.wolfbang.fsync.missionlist._di.DaggerMissionListComponent;
import com.wolfbang.fsync.missionlist._di.MissionListComponent;
import com.wolfbang.fsync.missionlist._di.MissionListModule;
 ...
 * @date 2018-05-03
 */
public class MissionListFragment
        extends AbstractMvpViewFragment<Presenter, Model, MissionListComponent>
        implements View,
                   Navigation,
                   BackClickHandler {
    ...
    public static Intent createIntent(Context context) {
        Intent intent = new SingleFragActivity.Builder(context, MissionListFragment.class.getName())
...
//        intent.putExtra(MCF_SCAN_RESULT, objectRegistry.put(scanResult));
    ...
    @NonNull
    @Override
    protected MissionListComponent createComponent() {
        return DaggerMissionListComponent.builder()
                                         .fsyncApplicationComponent(FsyncApplication.getFsyncApplicationComponent())
                                         .missionListModule(new MissionListModule())
                                         .build();
    }

    @Override
    protected void doInjection(@NonNull MissionListComponent component) {
        component.inject(this);
    }

    @NonNull
    @Override
    protected Presenter createPresenter(@NonNull MissionListComponent component) {
